 ...
 */
package org.havocosrevived.updater.misc;
...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.havocosrevived.build.version";
    public static final String PROP_DEVICE = "ro.havocosrevived.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "havocosrevived.updater.allow_downgrading";
